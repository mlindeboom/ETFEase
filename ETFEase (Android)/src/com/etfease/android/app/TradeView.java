...
public class TradeView extends Activity {
	...
	public void onCreate(Bundle icicle)
	{
		...
		portfolio.init(main.passETF.getSymbol());
		ETF etf = portfolio.getEtfs().get(main.passETF.getSymbol());

		setContentView(R.layout.trades_view);
		//ETF etf = main.passETF;
		...
		String chart = CHART.replaceAll("<SYMBOL>",main.passETF.getSymbol());
		String days = "1";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
	    ...
	    String symbol = main.passETF.getSymbol();
