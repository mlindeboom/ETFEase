...
public class tradesListhandler extends DefaultHandler
{
	...
	public tradesListhandler(Stack path, Map params, Attributes attributes, SAXParser parser, DefaultHandler parent)  throws SAXException
	{
		this.path = path;
		this.params = params;
		this.parent = parent;
	...
	public void startElement(java.lang.String uri, java.lang.String localName, java.lang.String qName, Attributes attributes) throws SAXException
	{
		...
		if (localName.equals("com.etfease.datasource.Trades"))
		{
			...
			path.push(etf);
			DefaultHandler handler = new Tradeshandler(path,params,attributes,parser,this);
